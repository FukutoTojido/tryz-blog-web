	...
	return (
		<>
			<img
				...
				alt=""
			/>
			<div className="bg-base/96 text-text min-h-full md:h-full flex-1 p-5 rounded-xl max-lg:rounded-none border-1 max-lg:border-0 border-overlay-0 shadow-xl backdrop-blur-md">
				<div className="w-full h-full flex gap-2.5 max-lg:flex-col">
					...
					<div className="flex-1 h-full flex flex-col p-5 max-lg:p-0 md:overflow-hidden">
						<Outlet />
					</div>
				</div>
			</div>
